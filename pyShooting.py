...
class Fighter(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load('Elements/fighter.png')
...
class Missile(pygame.sprite.Sprite):
    def __init__(self, xpos, ypos, speed):
        ...
        self.image = pygame.image.load('Elements/missile.png')
        self.rect = self.image.get_rect()
        self.rect.x = xpos
        self.rect.y = ypos
        self.speed = speed
        self.sound = pygame.mixer.Sound('Elements/missile.wav')
...
class Rock(pygame.sprite.Sprite):
    def __init__(self, xpos, ypos, speed):
        ...
        rock_images = ('Elements/rock01.png', 'Elements/rock02.png', 'Elements/rock03.png', 'Elements/rock04.png', 'Elements/rock05.png',\
                       'Elements/rock06.png', 'Elements/rock07.png', 'Elements/rock08.png', 'Elements/rock09.png', 'Elements/rock10.png',\
                       'Elements/rock11.png', 'Elements/rock12.png', 'Elements/rock13.png', 'Elements/rock14.png', 'Elements/rock15.png',\
                       'Elements/rock16.png', 'Elements/rock17.png', 'Elements/rock18.png', 'Elements/rock19.png', 'Elements/rock20.png',\
                       'Elements/rock21.png', 'Elements/rock22.png', 'Elements/rock23.png', 'Elements/rock24.png', 'Elements/rock25.png',\
                       'Elements/rock26.png', 'Elements/rock27.png', 'Elements/rock28.png', 'Elements/rock29.png', 'Elements/rock30.png')
...
def occur_explosion(surface, x, y):
    explosion_image = pygame.image.load('Elements/explosion.png')
    explosion_rect = explosion_image.get_rect()
    explosion_rect.x = x
    explosion_rect.y = y
    surface.blit(explosion_image, explosion_rect)

    explosion_sounds = ('Elements/explosion01.wav', 'Elements/explosion02.wav', 'Elements/explosion03.wav')
    explosion_sound = pygame.mixer.Sound(random.choice(explosion_sounds))
    explosion_sound.play()

def game_loop():
        default_font = pygame.font.Font('NanumGothic.ttf', 28)
        background_image = pygame.image.load('Elements/background.png')
        gameover_sound = pygame.mixer.Sound('Elements/gameover.wav')
        pygame.mixer.music.load('Elements/music.wav')
...
def game_menu():
    start_image = pygame.image.load('Elements/background.png')
    ...
    draw_text('운석을 피해라!', font_70, screen, draw_x, draw_y, YELLOW)
    draw_text('엔터키를 누르면', font_40, screen, draw_x, draw_y + 200, WHITE)
    draw_text('게임 시작!', font_40, screen, draw_x, draw_y +250, WHITE)
